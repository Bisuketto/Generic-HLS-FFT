...
#define COS_LUT COS_LUT_N1024_Q2_14 //COS_LUT_HELPER(NFFT, 2, TW_WIDTH-2)
#endif

#ifndef SIN_LUT
#define SIN_LUT_CONCAT(N, I, F) SIN_LUT_N##N##_Q##I##_##F
#define SIN_LUT_HELPER(N, I, F) SIN_LUT_CONCAT(N, I, F)
#define SIN_LUT SIN_LUT_N1024_Q2_14 //SIN_LUT_HELPER(NFFT, 2, TW_WIDTH-2)
#endif
